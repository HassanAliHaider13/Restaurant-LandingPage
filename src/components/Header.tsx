    ...
    >
      <nav className="container-width">
        <div className="flex items-center justify-between h-16 md:h-20">
          {/* Brand: Logo + Site name (placed flush with no gap) */}
          <div className="flex items-center flex-shrink-0">
            <img src={Logo} width={65} height={65} className="block" alt="Aal-E-Imran logo" />
            <span className="text-xl font-bold text-foreground ml-0 pl-5">
              Aal-E-Imran
            </span>
          </div>
