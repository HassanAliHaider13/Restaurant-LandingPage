  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          Welcome to <span className="text-primary">Aal-E-Imran</span>
        </h1>
        ...
        >
          “Where authentic Pakistani flavors come to life. From rich desi chicken and aseel chicken salan to slow-cooked haleem and classic channay — every dish is made with tradition and love.”
        </p>
